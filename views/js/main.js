...
var resizePizzas = function(size) {
 ...
 function changePizzaSizes(size) {
  ...
  // Saved the array length, which is part of the condition statement, in a local variable, so the array's length property is not accessed to check its value at each iteration. 
...
function updatePositions() {
 ...
 // If this is made global, moving pizza breaks
